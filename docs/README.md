<p align="center">
  <h1 align="center"><br><ins>AI-ARXIV-DAILY</ins><br>Automatically Update AI Papers Daily using Github Actions</h1>
...
- `main.py`: main scripts to processing given configurations
